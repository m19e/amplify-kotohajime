...
export declare type Person = LazyLoading extends LazyLoadingDisabled
  ? EagerPerson
  : LazyPerson
...
export declare const Person: (new (init: ModelInit<Person>) => Person) & {
  copyOf(
    source: Person,
    mutator: (draft: MutableModel<Person>) => MutableModel<Person> | void,
  ): Person
}
...
export declare type Board = LazyLoading extends LazyLoadingDisabled
  ? EagerBoard
  : LazyBoard
...
export declare const Board: (new (init: ModelInit<Board>) => Board) & {
  copyOf(
    source: Board,
    mutator: (draft: MutableModel<Board>) => MutableModel<Board> | void,
  ): Board
}
